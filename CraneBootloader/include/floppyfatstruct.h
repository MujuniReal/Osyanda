...
TotSectsFS:	.word 0x0000
		.word 0x0000	//This here is the total number of sectors in the filesystem 4Bytes
...
DrvSeriNum:	.word 0x6c29
		.word 0x550e	//This is the drive Serial Number comes with the drive it spans 4Bytes
