...
MedDescr:	.byte 0xf0	//The media descriptor of a floppy disk 1Byte for any floppy disk 0xf0 for removable, f8 for fixed media eg hardisk
...
TotSectsInFS:   .word 0x0000
		...
		.word 0x0000
LogDrvNo:	.byte 0x00	//Logical Drive Number 1Byte. This here is tobe initialized at boot time from the %dl register coz the %dl register holds the number of the selected device as seen from the BIOS perspective 0x0 means a drive disk, hardisks start at 0x80
Resrvd:		.byte 0x00	//This here is reserved space 1Byte means current head in use probably
