...
void loadFatDependancies(char *fatbpb) {
  ...
  activeBpb = (fatbpb1216 *)(fatbpb + FATBPBOFFSET);
  sectsPerTrack = activeBpb->SectsPTrck;
  totalHeads = activeBpb->NHeads;
