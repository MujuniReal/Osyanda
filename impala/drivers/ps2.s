...
get_ps2_stat:	
	...
	test $0x10,%al
	jz one_channel					/* the code upon this jump means that the ps2 has only one channel ie supports one device on either keyboard or mouse for our system here it was set */
	/* the code below here means that the PS2 controller has 2 channels ie keyboard and mouse */
one_channel:
	/* In the future we will set neccessary system configurations for this */	
